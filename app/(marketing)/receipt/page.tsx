    ...
    <div className="min-h-screen bg-neutral-100 py-8 print:bg-white print:py-0">
      ...
      <div className="max-w-4xl mx-auto px-6 mt-6 print:hidden">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
          <div className="font-semibold mb-2">📄 Visa Application Tip:</div>
          <p>
            This receipt includes all necessary information for visa applications, including your booking reference,
            accommodation details, and dates of stay. Simply print or save this page as PDF for your visa documentation.
          </p>
        </div>
      </div>
    </div>
