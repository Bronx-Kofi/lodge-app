        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-bold text-dark mb-2">Get Your Official Receipt</h2>
              <p className="text-neutral-600 mb-4">
                Download your professional reservation receipt for visa applications, expense reports, or your records.
              </p>
              <a
                href={`/receipt?reference=${booking.bookingReference}&email=${encodeURIComponent(email || booking.guestEmail)}`}
                target="_blank"
              ...
              <p className="text-xs text-neutral-500 mt-3">
                💡 Perfect for international guests requiring visa documentation
              </p>
            </div>
          </div>
        </motion.div>
